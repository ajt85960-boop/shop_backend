...
CREATE TABLE `users`  (
  ...
  `register_source` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'mobile' COMMENT '注册来源：mobile, wechat, web',
